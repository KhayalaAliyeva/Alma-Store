...
const project_title = "Alma Store";
const domain_name = "https://tut.az/";

const SEO = ({
  title,
  description = "The best testing environment made real!",
  thumbnail = "/img/thumbnail.png",
  url = "https://tut.az",
}) => {
  return (
    <Head>
      <title>Alma Store{title && ` | ${title}`}</title>
      ...
      <link rel="icon" href="../public/images/favicon/favicon-az.png" type="image/x-icon" />
